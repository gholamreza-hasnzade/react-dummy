...
const viewIcon = (
  <svg width="16" height="16" fill="none" viewBox="0 0 20 20">
    <path d="M1.75 10C3.5 5.75 7.5 3 10 3s6.5 2.75 8.25 7c-1.75 4.25-5.75 7-8.25 7s-6.5-2.75-8.25-7z" stroke="#2563eb" strokeWidth="1.5" fill="none"/>
    <circle cx="10" cy="10" r="3" stroke="#2563eb" strokeWidth="1.5" fill="none"/>
...
const editIcon = (
  <svg width="16" height="16" fill="none" viewBox="0 0 20 20">
    <path d="M13.5 3.5l3 3L6.5 16.5H3.5v-3L13.5 3.5z" stroke="#f59e42" strokeWidth="1.5" fill="none"/>
...
const deleteIcon = (
  <svg width="16" height="16" fill="none" viewBox="0 0 20 20">
    <rect x="5" y="7" width="10" height="8" rx="2" stroke="#ef4444" strokeWidth="1.5" fill="none"/>
