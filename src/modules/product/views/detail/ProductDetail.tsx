  ...
  const {
    ...
    queryFn: async () => {
      ...
      if (cachedData) {
        ...
        const cachedProduct = parsedCache.products.find(
      ...
      <div className="text-center py-8">
        <p className="text-red-500">
          {error instanceof Error
            ? error.message
            : t("products.detail.productNotFound")}
        </p>
        <Button
          variant="outline"
          color="primary"
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                {[
                  ...
                  },
                  {
                    ...
                    value: `${product.minimumOrderQuantity} ${t(
                      "products.detail.units"
                    )}`,
                  },
                ].map((detail, index) => (
                  <div key={index}>
                    <span className="font-semibold">{t(detail.label)}:</span>{" "}
                    {detail.value}
                  </div>
                ))}
              </div>
              ...
              <div className="border-t pt-4 mt-4">
                <h3 className="font-semibold mb-2">
                  {t("products.detail.shippingAndReturns")}
                </h3>
              ...
              <div className="border-t pt-4 mt-4">
                <h3 className="font-semibold mb-2">
                  {t("products.detail.customerReviews")}
                </h3>
                <div className="space-y-4">
                  {product.reviews.map(
                    (
